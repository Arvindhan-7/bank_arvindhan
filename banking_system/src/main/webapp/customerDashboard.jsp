...
<body>
	...
	<form action="CustomerController" method="post">
		<input type="hidden" name="action" value="deposit"> <input
			type="hidden" name="accountNo" value="<%= customer.getAccountNo() %>">
	...
	<form action="CustomerController" method="post">
		...
		<label for="transferAmount">Transfer Amount:</label> <input
			type="number" id="transferAmount" name="transferAmount" required>
		<label for="transferAccountNo">Transfer Account No:</label> <input
			type="text" id="transferAccountNo" name="transferAccountNo" required>
	...
	<form action="CustomerController" method="post">
		...
		<label for="newPassword">New Password:</label> <input type="password"
			...
			for="confirmPassword">Confirm New Password:</label> <input
